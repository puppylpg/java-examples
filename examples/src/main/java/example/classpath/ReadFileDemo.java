...
public class ReadFileDemo {
    ...
    public static void main(String[] args) {
        ...
        URL url = ReadFileDemo.class.getClassLoader().getResource("src/main/resources/config/example.properties");
        try {
            read(url.getPath());
        } catch (IOException e) {
            e.printStackTrace();
        ...
        URL togetherWithClass = ReadFileDemo.class.getResource("/src/main/resources/config/example.properties");
        try {
