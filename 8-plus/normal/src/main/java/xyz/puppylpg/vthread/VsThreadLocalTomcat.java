 ...
 */
public class VsThreadLocalTomcat {

    private static final String URI_TEMPLATE = "http://localhost:8080/?loop=%d";
    private static final ExecutorService EXECUTOR = Executors.newCachedThreadPool();
    private static final ExecutorService V_EXECUTOR = Executors.newVirtualThreadPerTaskExecutor();

    public static void main(String... args) throws URISyntaxException {
        // async request, total time={1430}ms
        sendAsync(EXECUTOR);
        // async request, total time={1075}ms
